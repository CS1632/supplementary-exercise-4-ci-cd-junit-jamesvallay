...
public class RentACatTest {
	...
	public void testGetCatNullNumCats0() {
		// TODO
		Cat obs = r.getCat(2);
		assertNull("returned cat from empty r is not null", obs);
	}
	...
	public void testCatAvailableFalseNumCats0() {
		// TODO
		boolean obs = r.catAvailable(2);
		assertFalse("Cat with id 2 was said to be available when r was empty", obs);
	}
	...
	public void testCatAvailableTrueNumCats3() {
		...
		boolean obs = r.catAvailable(2);
		////////////////////////////////////////////////
		//do we have to account for catAvailable accessing getter of Cat class 3? Or no since only asserting info about c2?
		///////////////////////////////////////////////
		assertTrue("Cat with id 2 is listed an unavailable, although they have not been rented", obs);
	}
	...
	public void testCatAvailableFalseNumCats3() {
		...
		boolean obs = r.catAvailable(2);
		////////////////////////////////////////////////
		//have to account for catAvailable accessing getter of Cat class
		///////////////////////////////////////////////
		assertFalse("Cat with id 2 is listed available, although they are being rented", obs);
	}
	...
	public void testCatExistsFalseNumCats0() {
		// TODO
		boolean obs = r.catExists(2);
		assertFalse("Cat with id 2 said to exist in r, when r is empty", obs);
	}
	...
	public void testCatExistsTrueNumCats3() {
		...
		r.addCat(c3);
		boolean obs = r.catExists(2);
		assertTrue("Cat with id 2 not found, but was just added to r", obs);
	}
	...
	public void testListCatsNumCats0() {
		// TODO
		String obs = r.listCats();
		assertEquals("Observed list of cats was not empty string when r has no cats", "", obs);
	}
	...
	public void testListCatsNumCats3() {
		...
		r.addCat(c3);
		String obs = r.listCats();
		assertEquals("Observed list of cats did not include all 3 cats in correct format", "ID 1. Jennyanydots\nID 2. Old Deuteronomy\nID 3. Mistoffelees\n", obs);
	}
	...
	public void testRentCatFailureNumCats3() {
		...
		Mockito.when(c2.getRented()).thenReturn(true);
		boolean obs = r.rentCat(2);
		assertFalse("Cat ID: 2 - attempt to rent rented cat returning true", obs);
	...
	public void testReturnCatFailureNumCats0() {
		// TODO
		boolean obs = r.returnCat(2);
		assertFalse("was successful in returning cat with ID 2 when r has no cats", obs);
	}
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue("Return Cat ID: 2 - successful", r.returnCat(2));
